...
img1 = cv.imread('augo/scene2/1.jpg')
...
img2 = cv.imread('augo/scene2/2.jpg')
...
cv2.imwrite('results/augo/scene2/dimg12.jpg', dimg12)
cv.waitKey(0)
...
cv2.imwrite('results/augo/scene2/panorama12.jpg', panorama12)
...
img3 = cv.imread('augo/scene2/3.jpg')
...
img4 = cv.imread('augo/scene2/4.jpg')
...
cv2.imwrite('results/augo/scene2/panorama34.jpg', panorama34)
...
cv2.imwrite('results/augo/scene2/dimg34.jpg', dimg34)
...
cv2.imwrite('results/augo/scene2/final_dimg.jpg', final_dimg)
cv.waitKey(0)
...
cv2.imwrite('results/augo/scene2/final_panorama.jpg', final_panorama)
cv.waitKey(0)
