...
cv2.imwrite('../results/augo/scene1/SURF/dimg12.jpg', dimg12)
cv.waitKey(0)
...
cv2.imwrite('../results/augo/scene1/SURF/panorama12.jpg', panorama12)
...
cv2.imwrite('../results/augo/scene1/SURF/panorama34.jpg', panorama34)
...
cv2.imwrite('../results/augo/scene1/SURF/dimg34.jpg', dimg34)
...
cv2.imwrite('../results/augo/scene1/SURF/final_dimg.jpg', final_dimg)
cv.waitKey(0)
...
cv2.imwrite('../results/augo/scene1/SURF/final_panorama.jpg', final_panorama)
cv.waitKey(0)
