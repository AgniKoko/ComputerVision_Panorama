...
img1 = cv.imread('scene1_resized/1.jpg')
cv.namedWindow('img1')
cv.imshow('img1', img1)
cv.waitKey(0)
...
img2 = cv.imread('scene1_resized/2.jpg')
cv.namedWindow('img2')
cv.imshow('img2', img2)
cv.waitKey(0)
...
cv2.imwrite('../results/augo/scene1_resized/dimg12.jpg', dimg12)
cv.waitKey(0)
...
def create_panorama(img1, img2, kp1, kp2, desc1, desc2, matches):
    ...
    panorama = cv.warpPerspective(img2, M, (img1.shape[1] + 3000, img1.shape[0] + 3000))
...
cv2.imwrite('../results/augo/scene1_resized/panorama12.jpg', panorama12)
...
img3 = cv.imread('scene1_resized/3.jpg')
cv.namedWindow('img3')
cv.imshow('img3', img3)
cv.waitKey(0)
...
img4 = cv.imread('scene1_resized/4.jpg')
cv.namedWindow('img4')
cv.imshow('img4', img4)
cv.waitKey(0)
...
cv2.imwrite('../results/augo/scene1_resized/panorama34.jpg', panorama34)
...
cv2.imwrite('../results/augo/scene1_resized/dimg34.jpg', dimg34)
...
cv2.imwrite('../results/augo/scene1_resized/final_dimg.jpg', final_dimg)
cv.waitKey(0)
...
cv2.imwrite('../results/augo/scene1_resized/final_panorama.jpg', final_panorama)
cv.waitKey(0)
