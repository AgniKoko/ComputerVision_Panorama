...
def resize_image(img, width=700):
    h, w = img.shape[:2]
    aspect_ratio = h / w
...
cv2.imwrite('results/GES-50/SURF/dimg12.jpg', dimg12)
cv.waitKey(0)
...
cv2.imwrite('results/GES-50/SURF/panorama12.jpg', panorama12)
...
cv2.imwrite('results/GES-50/SURF/dimg34.jpg', dimg34)
...
cv2.imwrite('results/GES-50/SURF/panorama34.jpg', panorama34)
...
cv2.imwrite('results/GES-50/SURF/final_dimg.jpg', final_dimg)
cv.waitKey(0)
...
cv2.imwrite('results/GES-50/SURF/final_panorama.jpg', final_panorama)
cv.waitKey(0)
