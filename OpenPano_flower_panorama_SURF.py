...
cv2.imwrite('results/OpenPano/flower/SURF/dimg12.jpg', dimg12)
cv.waitKey(0)
...
cv2.imwrite('results/OpenPano/flower/SURF/panorama12.jpg', panorama12)
...
cv2.imwrite('results/OpenPano/flower/SURF/dimg34.jpg', dimg34)
...
cv2.imwrite('results/OpenPano/flower/SURF/panorama34.jpg', panorama34)
...
cv2.imwrite('results/OpenPano/flower/SURF/final_dimg.jpg', final_dimg)
cv.waitKey(0)
...
cv2.imwrite('results/OpenPano/flower/SURF/final_panorama.jpg', final_panorama)
cv.waitKey(0)
