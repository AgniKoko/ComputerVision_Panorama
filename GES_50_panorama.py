...
cv2.imwrite('results/GES-50/panorama23.jpg', panorama23)
...
cv2.imwrite('results/GES-50/dimg23.jpg', dimg23)
...
cv2.imwrite('results/GES-50/final_dimg123.jpg', final_dimg123)
cv.waitKey(0)
...
cv2.imwrite('results/GES-50/final_panorama123.jpg', final_panorama123)
...
cv2.imwrite('results/GES-50/final_dimg234.jpg', final_dimg234)
cv.waitKey(0)
...
cv2.imwrite('results/GES-50/final_panorama234.jpg', final_panorama234)
...
gray123 = cv2.cvtColor(final_panorama123, cv2.COLOR_BGR2GRAY)
_, thresh12 = cv2.threshold(gray123, 1, 255, cv2.THRESH_BINARY)
x, y, w, h = cv2.boundingRect(thresh12)
cropped_panorama123 = final_panorama123[y:y+h, x:x+w]

gray234 = cv2.cvtColor(final_panorama234, cv2.COLOR_BGR2GRAY)
_, thresh12 = cv2.threshold(gray234, 1, 255, cv2.THRESH_BINARY)
x, y, w, h = cv2.boundingRect(thresh12)
cropped_panorama234 = final_panorama234[y:y+h, x:x+w]
...
final_dimg = cv.drawMatches(cropped_panorama123, desc123[0], cropped_panorama234, desc234[0], matches_final, None)
...
final_panorama = create_panorama(cropped_panorama123, cropped_panorama234, kp123, kp234, desc123, desc234, matches_final)
